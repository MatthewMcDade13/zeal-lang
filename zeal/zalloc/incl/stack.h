#ifndef ZEAL_ALLOC_INCL_STACK_H_
#define ZEAL_ALLOC_INCL_STACK_H_

#include "common.h"


ZEAL_NAMESPACE_CAPI_BEGIN(alloc)

typedef struct zl_StackAlloc zl_StackAlloc;
typedef zl_StackAlloc* const zl_StackAllocator;

typedef unsigned int zl_StackSlot;

typedef struct zl_StackItem zl_StackItem;
...
zl_StackAllocator zl_stackalloc_instance(void);
