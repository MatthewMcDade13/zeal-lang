...
extern zl_CommandArgs zl_parse_args(int argc, char** argv) ZEAL_NOEXCEPT;
...
namespace args {
  static inline zl_CommandArgs parse(int argc, char** argv) ZEAL_NOEXCEPT {
    return zl_parse_args(argc, argv);
  }
}
