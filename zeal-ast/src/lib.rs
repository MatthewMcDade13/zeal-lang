...
/// `AstWalker<Node, VisitReturn = ()>`
///
/// Ast Walker trait.
/// @Template Node: The Node type that will be visited
/// @Template: R: Return type of visit. Can be used for reducing/mapping
/// Tree into a new Type. i.e.
///
/// # Example
///
/// ```rust
///     impl AstWalker<Expr, String> for AstStringify {
///         fn visit(&mut self, node: &Node) -> anyhow::Result<String> {
///             //...
///         }
///
///  
